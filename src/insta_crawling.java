...
public class insta_crawling {
    ...
    public static void main(String[] args) {
        ...
        try
        {
            ...
            Elements e1 = doc.getElementsByAttributeValue("class","KL4Bh"); // e1 에 class 값이 KL4Bh 인 부분 담기
            Elements img1 = doc.select("div.KL4Bh");
            Elements e2 = doc.getElementsByClass("KL4Bh");
            Elements e3 = doc.getElementsByTag("KL4Bh");
